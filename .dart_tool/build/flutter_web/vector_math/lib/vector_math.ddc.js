define(['dart_sdk', 'packages/vector_math/hash'], function(dart_sdk, packages__vector_math__hash) {
  ...
  const vector_math = Object.create(dart.library);
  const $abs = dartx.abs;
  ...
  const _min = dart.privateName(vector_math, "_min");
  const _max = dart.privateName(vector_math, "_max");
  vector_math.Aabb2 = class Aabb2 extends core.Object {
    ...
    transform(t) {
      let t0, t0$, t0$0;
      let center = new vector_math.Vector2.zero();
      let halfExtents = new vector_math.Vector2.zero();
    ...
    hull(other) {
      vector_math.Vector2.min(this[_min], other[_min], this[_min]);
      vector_math.Vector2.max(this[_max], other[_max], this[_max]);
    }
    hullPoint(point) {
      vector_math.Vector2.min(this[_min], point, this[_min]);
      vector_math.Vector2.max(this[_max], point, this[_max]);
    }
    containsAabb2(other) {
  ...
  (vector_math.Aabb2.new = function() {
    this[_min] = new vector_math.Vector2.zero();
    this[_max] = new vector_math.Vector2.zero();
    ;
  }).prototype = vector_math.Aabb2.prototype;
  (vector_math.Aabb2.copy = function(other) {
    this[_min] = vector_math.Vector2.copy(other[_min]);
    this[_max] = vector_math.Vector2.copy(other[_max]);
    ;
  }).prototype = vector_math.Aabb2.prototype;
  (vector_math.Aabb2.minMax = function(min, max) {
    this[_min] = vector_math.Vector2.copy(min);
    this[_max] = vector_math.Vector2.copy(max);
    ;
  }).prototype = vector_math.Aabb2.prototype;
  (vector_math.Aabb2.fromBuffer = function(buffer, offset) {
    this[_min] = new vector_math.Vector2.fromBuffer(buffer, offset);
    this[_max] = new vector_math.Vector2.fromBuffer(buffer, dart.notNull(offset) + 4 * 2);
    ;
  }).prototype = vector_math.Aabb2.prototype;
  ...
  dart.setLibraryUri(vector_math.Aabb2, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Aabb2, () => ({
    __proto__: dart.getFields(vector_math.Aabb2.__proto__),
    [_min]: dart.finalFieldType(vector_math.Vector2),
    [_max]: dart.finalFieldType(vector_math.Vector2)
  }));
  const _radius = dart.privateName(vector_math, "_radius");
  const _center = dart.privateName(vector_math, "_center");
  const _point0 = dart.privateName(vector_math, "_point0");
  const _point1 = dart.privateName(vector_math, "_point1");
  const _point2 = dart.privateName(vector_math, "_point2");
  const _point3 = dart.privateName(vector_math, "_point3");
  const _depth = dart.privateName(vector_math, "_depth");
  vector_math.Aabb3 = class Aabb3 extends core.Object {
    ...
    transform(t) {
      let t0, t0$, t0$0;
      let center = new vector_math.Vector3.zero();
      let halfExtents = new vector_math.Vector3.zero();
      this.copyCenterAndHalfExtents(center, halfExtents);
      t0 = t;
    ...
    hull(other) {
      vector_math.Vector3.min(this[_min], other[_min], this[_min]);
      vector_math.Vector3.max(this[_max], other[_max], this[_max]);
    }
    hullPoint(point) {
      vector_math.Vector3.min(this[_min], point, this[_min]);
      vector_math.Vector3.max(this[_max], point, this[_max]);
    }
    containsAabb3(other) {
      let otherMax = other[_max];
      let otherMin = other[_min];
    ...
    containsSphere(other) {
      let boxExtends = vector_math.Vector3.all(other[_radius]);
      let sphereBox = vector_math.Aabb3.centerAndHalfExtents(other[_center], boxExtends);
    ...
    intersectsWithTriangle(other, opts) {
      ...
      t0$3;
      len = dart.notNull(vector_math.Aabb3._f0.y) * dart.notNull(vector_math.Aabb3._f0.y) + dart.notNull(vector_math.Aabb3._f0.z) * dart.notNull(vector_math.Aabb3._f0.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f0.y) - dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f0.z);
        p2 = dart.notNull(vector_math.Aabb3._v2.z) * dart.notNull(vector_math.Aabb3._f0.y) - dart.notNull(vector_math.Aabb3._v2.y) * dart.notNull(vector_math.Aabb3._f0.z);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f0.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f0.y[$abs]();
      ...
      len = dart.notNull(vector_math.Aabb3._f1.y) * dart.notNull(vector_math.Aabb3._f1.y) + dart.notNull(vector_math.Aabb3._f1.z) * dart.notNull(vector_math.Aabb3._f1.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f1.y) - dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f1.z);
        p1 = dart.notNull(vector_math.Aabb3._v1.z) * dart.notNull(vector_math.Aabb3._f1.y) - dart.notNull(vector_math.Aabb3._v1.y) * dart.notNull(vector_math.Aabb3._f1.z);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f1.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f1.y[$abs]();
      ...
      len = dart.notNull(vector_math.Aabb3._f2.y) * dart.notNull(vector_math.Aabb3._f2.y) + dart.notNull(vector_math.Aabb3._f2.z) * dart.notNull(vector_math.Aabb3._f2.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f2.y) - dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f2.z);
        p1 = dart.notNull(vector_math.Aabb3._v1.z) * dart.notNull(vector_math.Aabb3._f2.y) - dart.notNull(vector_math.Aabb3._v1.y) * dart.notNull(vector_math.Aabb3._f2.z);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f2.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f2.y[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p1), math.min(core.double, p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p1) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f0.x) * dart.notNull(vector_math.Aabb3._f0.x) + dart.notNull(vector_math.Aabb3._f0.z) * dart.notNull(vector_math.Aabb3._f0.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f0.z) - dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f0.x);
        p2 = dart.notNull(vector_math.Aabb3._v2.x) * dart.notNull(vector_math.Aabb3._f0.z) - dart.notNull(vector_math.Aabb3._v2.z) * dart.notNull(vector_math.Aabb3._f0.x);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f0.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f0.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p2), math.min(core.double, p0, p2)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p2) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f1.x) * dart.notNull(vector_math.Aabb3._f1.x) + dart.notNull(vector_math.Aabb3._f1.z) * dart.notNull(vector_math.Aabb3._f1.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f1.z) - dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f1.x);
        p1 = dart.notNull(vector_math.Aabb3._v1.x) * dart.notNull(vector_math.Aabb3._f1.z) - dart.notNull(vector_math.Aabb3._v1.z) * dart.notNull(vector_math.Aabb3._f1.x);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f1.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f1.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p1), math.min(core.double, p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p1) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f2.x) * dart.notNull(vector_math.Aabb3._f2.x) + dart.notNull(vector_math.Aabb3._f2.z) * dart.notNull(vector_math.Aabb3._f2.z);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f2.z) - dart.notNull(vector_math.Aabb3._v0.z) * dart.notNull(vector_math.Aabb3._f2.x);
        p1 = dart.notNull(vector_math.Aabb3._v1.x) * dart.notNull(vector_math.Aabb3._f2.z) - dart.notNull(vector_math.Aabb3._v1.z) * dart.notNull(vector_math.Aabb3._f2.x);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f2.z[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * vector_math.Aabb3._f2.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p1), math.min(core.double, p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p1) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f0.x) * dart.notNull(vector_math.Aabb3._f0.x) + dart.notNull(vector_math.Aabb3._f0.y) * dart.notNull(vector_math.Aabb3._f0.y);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f0.x) - dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f0.y);
        p2 = dart.notNull(vector_math.Aabb3._v2.y) * dart.notNull(vector_math.Aabb3._f0.x) - dart.notNull(vector_math.Aabb3._v2.x) * dart.notNull(vector_math.Aabb3._f0.y);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f0.y[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f0.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p2), math.min(core.double, p0, p2)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p2) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f1.x) * dart.notNull(vector_math.Aabb3._f1.x) + dart.notNull(vector_math.Aabb3._f1.y) * dart.notNull(vector_math.Aabb3._f1.y);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f1.x) - dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f1.y);
        p1 = dart.notNull(vector_math.Aabb3._v1.y) * dart.notNull(vector_math.Aabb3._f1.x) - dart.notNull(vector_math.Aabb3._v1.x) * dart.notNull(vector_math.Aabb3._f1.y);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f1.y[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f1.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p1), math.min(core.double, p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p1) - dart.notNull(r);
      ...
      len = dart.notNull(vector_math.Aabb3._f2.x) * dart.notNull(vector_math.Aabb3._f2.x) + dart.notNull(vector_math.Aabb3._f2.y) * dart.notNull(vector_math.Aabb3._f2.y);
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        p0 = dart.notNull(vector_math.Aabb3._v0.y) * dart.notNull(vector_math.Aabb3._f2.x) - dart.notNull(vector_math.Aabb3._v0.x) * dart.notNull(vector_math.Aabb3._f2.y);
        p1 = dart.notNull(vector_math.Aabb3._v1.y) * dart.notNull(vector_math.Aabb3._f2.x) - dart.notNull(vector_math.Aabb3._v1.x) * dart.notNull(vector_math.Aabb3._f2.y);
        r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * vector_math.Aabb3._f2.y[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * vector_math.Aabb3._f2.x[$abs]();
        if (math.max(core.double, -math.max(core.double, p0, p1), math.min(core.double, p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(core.double, p0, p1) - dart.notNull(r);
      ...
      if (math.max(core.double, vector_math.Aabb3._v0.x, math.max(core.double, vector_math.Aabb3._v1.x, vector_math.Aabb3._v2.x)) < -dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) || math.min(core.double, vector_math.Aabb3._v0.x, math.min(core.double, vector_math.Aabb3._v1.x, vector_math.Aabb3._v2.x)) > dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0))) {
        return false;
      }
      a = math.min(core.double, vector_math.Aabb3._v0.x, math.min(core.double, vector_math.Aabb3._v1.x, vector_math.Aabb3._v2.x)) - dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
        result.axis.setFrom(vector_math.Aabb3._u0);
      }
      if (math.max(core.double, vector_math.Aabb3._v0.y, math.max(core.double, vector_math.Aabb3._v1.y, vector_math.Aabb3._v2.y)) < -dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) || math.min(core.double, vector_math.Aabb3._v0.y, math.min(core.double, vector_math.Aabb3._v1.y, vector_math.Aabb3._v2.y)) > dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1))) {
        return false;
      }
      a = math.min(core.double, vector_math.Aabb3._v0.y, math.min(core.double, vector_math.Aabb3._v1.y, vector_math.Aabb3._v2.y)) - dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
        result.axis.setFrom(vector_math.Aabb3._u1);
      }
      if (math.max(core.double, vector_math.Aabb3._v0.z, math.max(core.double, vector_math.Aabb3._v1.z, vector_math.Aabb3._v2.z)) < -dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) || math.min(core.double, vector_math.Aabb3._v0.z, math.min(core.double, vector_math.Aabb3._v1.z, vector_math.Aabb3._v2.z)) > dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2))) {
        return false;
      }
      a = math.min(core.double, vector_math.Aabb3._v0.z, math.min(core.double, vector_math.Aabb3._v1.z, vector_math.Aabb3._v2.z)) - dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
    ...
    intersectsWithPlane(other, opts) {
      let result = opts && 'result' in opts ? opts.result : null;
      this.copyCenterAndHalfExtents(vector_math.Aabb3._aabbCenter, vector_math.Aabb3._aabbHalfExtents);
      let r = dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(0)) * other.normal._get(0)[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(1)) * other.normal._get(1)[$abs]() + dart.notNull(vector_math.Aabb3._aabbHalfExtents._get(2)) * other.normal._get(2)[$abs]();
      let s = dart.notNull(other.normal.dot(vector_math.Aabb3._aabbCenter)) - dart.notNull(other.constant);
      if (s[$abs]() <= r) {
        let a = s - r;
    ...
    intersectsWithQuad(other, opts) {
      ...
      return dart.test(this.intersectsWithTriangle(vector_math.Aabb3._quadTriangle0, {result: result})) || dart.test(this.intersectsWithTriangle(vector_math.Aabb3._quadTriangle1, {result: result}));
    }
  };
  (vector_math.Aabb3.new = function() {
    this[_min] = new vector_math.Vector3.zero();
    this[_max] = new vector_math.Vector3.zero();
    ;
  }).prototype = vector_math.Aabb3.prototype;
  (vector_math.Aabb3.copy = function(other) {
    this[_min] = vector_math.Vector3.copy(other[_min]);
    this[_max] = vector_math.Vector3.copy(other[_max]);
    ;
  }).prototype = vector_math.Aabb3.prototype;
  (vector_math.Aabb3.minMax = function(min, max) {
    this[_min] = vector_math.Vector3.copy(min);
    this[_max] = vector_math.Vector3.copy(max);
    ;
  }).prototype = vector_math.Aabb3.prototype;
  (vector_math.Aabb3.fromBuffer = function(buffer, offset) {
    this[_min] = new vector_math.Vector3.fromBuffer(buffer, offset);
    this[_max] = new vector_math.Vector3.fromBuffer(buffer, dart.notNull(offset) + 4 * 3);
    ;
  }).prototype = vector_math.Aabb3.prototype;
  ...
  dart.setMethodSignature(vector_math.Aabb3, () => ({
    ...
    intersectsWithTriangle: dart.fnType(core.bool, [vector_math.Triangle], {epsilon: core.double, result: vector_math.IntersectionResult}),
    intersectsWithPlane: dart.fnType(core.bool, [vector_math.Plane], {result: vector_math.IntersectionResult}),
    intersectsWithQuad: dart.fnType(core.bool, [vector_math.Quad], {result: vector_math.IntersectionResult})
  }));
  ...
  dart.setLibraryUri(vector_math.Aabb3, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Aabb3, () => ({
    __proto__: dart.getFields(vector_math.Aabb3.__proto__),
    [_min]: dart.finalFieldType(vector_math.Vector3),
    [_max]: dart.finalFieldType(vector_math.Vector3)
  }));
  ...
  vector_math.Colors = class Colors extends core.Object {
    ...
    static fromHexString(value, result) {
      let fullMatch = vector_math.Colors._hexStringFullRegex[$matchAsPrefix](value);
      if (fullMatch != null) {
      ...
      let smallMatch = vector_math.Colors._hexStringSmallRegex[$matchAsPrefix](value);
      if (smallMatch != null) {
    ...
    static hslToRgb(hslColor, rgbColor) {
      if (hslColor.y === 0.0) {
        ...
        let r = vector_math.Colors._hueToRgb(p, q, dart.notNull(hslColor.x) + 1.0 / 3.0);
        let g = vector_math.Colors._hueToRgb(p, q, hslColor.x);
        let b = vector_math.Colors._hueToRgb(p, q, dart.notNull(hslColor.x) - 1.0 / 3.0);
  ...
  dart.setLibraryUri(vector_math.Colors, "package:vector_math/vector_math.dart");
  ...
  const _plane0 = dart.privateName(vector_math, "_plane0");
  const _plane1 = dart.privateName(vector_math, "_plane1");
  const _plane2 = dart.privateName(vector_math, "_plane2");
  const _plane3 = dart.privateName(vector_math, "_plane3");
  const _plane4 = dart.privateName(vector_math, "_plane4");
  const _plane5 = dart.privateName(vector_math, "_plane5");
  const _intersectsWithAabb3CheckPlane = dart.privateName(vector_math, "_intersectsWithAabb3CheckPlane");
  const _normal = dart.privateName(vector_math, "_normal");
  const _constant = dart.privateName(vector_math, "_constant");
  vector_math.Frustum = class Frustum extends core.Object {
    ...
    calculateCorners(corner0, corner1, corner2, corner3, corner4, corner5, corner6, corner7) {
      vector_math.Plane.intersection(this[_plane0], this[_plane2], this[_plane4], corner0);
      vector_math.Plane.intersection(this[_plane0], this[_plane3], this[_plane4], corner1);
      vector_math.Plane.intersection(this[_plane0], this[_plane3], this[_plane5], corner2);
      vector_math.Plane.intersection(this[_plane0], this[_plane2], this[_plane5], corner3);
      vector_math.Plane.intersection(this[_plane1], this[_plane2], this[_plane4], corner4);
      vector_math.Plane.intersection(this[_plane1], this[_plane3], this[_plane4], corner5);
      vector_math.Plane.intersection(this[_plane1], this[_plane3], this[_plane5], corner6);
      vector_math.Plane.intersection(this[_plane1], this[_plane2], this[_plane5], corner7);
    }
  ...
  (vector_math.Frustum.new = function() {
    this[_plane0] = new vector_math.Plane.new();
    this[_plane1] = new vector_math.Plane.new();
    this[_plane2] = new vector_math.Plane.new();
    this[_plane3] = new vector_math.Plane.new();
    this[_plane4] = new vector_math.Plane.new();
    this[_plane5] = new vector_math.Plane.new();
    ;
  ...
  dart.setMethodSignature(vector_math.Frustum, () => ({
    ...
    [_intersectsWithAabb3CheckPlane]: dart.fnType(core.bool, [vector_math.Aabb3, vector_math.Plane])
  }));
  ...
  dart.setLibraryUri(vector_math.Frustum, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Frustum, () => ({
    __proto__: dart.getFields(vector_math.Frustum.__proto__),
    [_plane0]: dart.finalFieldType(vector_math.Plane),
    [_plane1]: dart.finalFieldType(vector_math.Plane),
    [_plane2]: dart.finalFieldType(vector_math.Plane),
    [_plane3]: dart.finalFieldType(vector_math.Plane),
    [_plane4]: dart.finalFieldType(vector_math.Plane),
    [_plane5]: dart.finalFieldType(vector_math.Plane)
  }));
  const IntersectionResult_axis = dart.privateName(vector_math, "IntersectionResult.axis");
  ...
  (vector_math.IntersectionResult.new = function() {
    this[_depth] = null;
    this[axis] = new vector_math.Vector3.zero();
    ;
  ...
  dart.setLibraryUri(vector_math.IntersectionResult, "package:vector_math/vector_math.dart");
  ...
  const _m2storage = dart.privateName(vector_math, "_m2storage");
  const _v2storage$ = dart.privateName(vector_math, "_v2storage");
  vector_math.Matrix2 = class Matrix2 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix2.dart", 39, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix2.dart", 40, 12, "(col >= 0) && (col < dimension)");
      return this[_m2storage][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix2.dart", 47, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix2.dart", 48, 12, "(col >= 0) && (col < dimension)");
    ...
    _equals(other) {
      ...
      return vector_math.Matrix2.is(other) && this[_m2storage][$_get](0) == other[_m2storage][$_get](0) && this[_m2storage][$_get](1) == other[_m2storage][$_get](1) && this[_m2storage][$_get](2) == other[_m2storage][$_get](2) && this[_m2storage][$_get](3) == other[_m2storage][$_get](3);
    }
    get hashCode() {
  ...
  (vector_math.Matrix2.zero = function() {
    this[_m2storage] = _native_typed_data.NativeFloat32List.new(4);
    ;
  ...
  dart.setMethodSignature(vector_math.Matrix2, () => ({
    ...
    transformed: dart.fnType(vector_math.Vector2, [vector_math.Vector2], [vector_math.Vector2]),
  ...
  dart.setLibraryUri(vector_math.Matrix2, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Matrix2, () => ({
    __proto__: dart.getFields(vector_math.Matrix2.__proto__),
    [_m2storage]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  const _m3storage = dart.privateName(vector_math, "_m3storage");
  const _v3storage$ = dart.privateName(vector_math, "_v3storage");
  vector_math.Matrix3 = class Matrix3 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix3.dart", 87, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix3.dart", 88, 12, "(col >= 0) && (col < dimension)");
      return this[_m3storage][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix3.dart", 95, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix3.dart", 96, 12, "(col >= 0) && (col < dimension)");
    ...
    applyToVector3Array(array, offset) {
      ...
      for (let i = 0, j = offset; i < dart.notNull(array[$length]); i = i + 3, j = dart.notNull(j) + 3) {
        let v = (t0 = vector_math.Vector3.array(array, j), t0.applyMatrix3(this), t0);
  ...
  (vector_math.Matrix3.zero = function() {
    this[_m3storage] = _native_typed_data.NativeFloat32List.new(9);
    ;
  ...
  dart.setMethodSignature(vector_math.Matrix3, () => ({
    ...
    transformed: dart.fnType(vector_math.Vector3, [vector_math.Vector3], [vector_math.Vector3]),
    copyIntoArray: dart.fnType(dart.void, [core.List$(core.num)], [core.int]),
    copyFromArray: dart.fnType(dart.void, [core.List$(core.double)], [core.int]),
  ...
  dart.setLibraryUri(vector_math.Matrix3, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Matrix3, () => ({
    __proto__: dart.getFields(vector_math.Matrix3.__proto__),
    [_m3storage]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  const _m4storage$ = dart.privateName(vector_math, "_m4storage");
  const _v4storage$ = dart.privateName(vector_math, "_v4storage");
  const _qStorage$ = dart.privateName(vector_math, "_qStorage");
  vector_math.Matrix4 = class Matrix4 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix4.dart", 167, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix4.dart", 168, 12, "(col >= 0) && (col < dimension)");
      return this[_m4storage$][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix4.dart", 175, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/matrix4.dart", 176, 12, "(col >= 0) && (col < dimension)");
    ...
    decompose(translation, rotation, scale) {
      ...
      let v = new vector_math.Vector3.zero();
      ...
      let m = vector_math.Matrix4.copy(this);
      t0$1 = m[_m4storage$];
      t1 = 0;
    ...
    applyToVector3Array(array, offset) {
      ...
      if (offset === void 0) offset = 0;
      for (let i = 0, j = offset; i < dart.notNull(array[$length]); i = i + 3, j = dart.notNull(j) + 3) {
        let v = (t0 = vector_math.Vector3.array(array, j), t0.applyMatrix4(this), t0);
        array[$_set](j, v.storage[$_get](0));
        array[$_set](dart.notNull(j) + 1, v.storage[$_get](1));
        array[$_set](dart.notNull(j) + 2, v.storage[$_get](2));
      }
  ...
  (vector_math.Matrix4.zero = function() {
    this[_m4storage$] = _native_typed_data.NativeFloat32List.new(16);
    ;
  ...
  (vector_math.Matrix4.fromBuffer = function(buffer, offset) {
    this[_m4storage$] = typed_data.Float32List.view(buffer, offset, 16);
    ;
  }).prototype = vector_math.Matrix4.prototype;
  ...
  dart.setMethodSignature(vector_math.Matrix4, () => ({
    ...
    scaled: dart.fnType(vector_math.Matrix4, [dart.dynamic], [core.double, core.double]),
    setZero: dart.fnType(dart.void, []),
    setIdentity: dart.fnType(dart.void, []),
    ...
    rotated3: dart.fnType(vector_math.Vector3, [vector_math.Vector3], [vector_math.Vector3]),
    transform3: dart.fnType(vector_math.Vector3, [vector_math.Vector3]),
    transformed3: dart.fnType(vector_math.Vector3, [vector_math.Vector3], [vector_math.Vector3]),
    ...
    transformed: dart.fnType(vector_math.Vector4, [vector_math.Vector4], [vector_math.Vector4]),
    copyIntoArray: dart.fnType(dart.void, [core.List$(core.num)], [core.int]),
    copyFromArray: dart.fnType(dart.void, [core.List$(core.double)], [core.int]),
    applyToVector3Array: dart.fnType(core.List$(core.double), [core.List$(core.double)], [core.int]),
    isIdentity: dart.fnType(core.bool, []),
  ...
  dart.setLibraryUri(vector_math.Matrix4, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Matrix4, () => ({
    __proto__: dart.getFields(vector_math.Matrix4.__proto__),
    [_m4storage$]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  const _halfExtents = dart.privateName(vector_math, "_halfExtents");
  const _axis0 = dart.privateName(vector_math, "_axis0");
  const _axis1 = dart.privateName(vector_math, "_axis1");
  const _axis2 = dart.privateName(vector_math, "_axis2");
  vector_math.Obb3 = class Obb3 extends core.Object {
    ...
    copyCorner(cornerIndex, corner) {
      ...
      if (!(dart.notNull(cornerIndex) >= 0 || dart.notNull(cornerIndex) < 8)) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/obb3.dart", 114, 12, "cornerIndex >= 0 || cornerIndex < 8");
    ...
    intersectsWithObb3(other, epsilon) {
      ...
      t0$.sub(this[_center]);
      t0$;
      vector_math.Obb3._t.setValues(vector_math.Obb3._t.dot(this[_axis0]), vector_math.Obb3._t.dot(this[_axis1]), vector_math.Obb3._t.dot(this[_axis2]));
      for (let i = 0; i < 3; i = i + 1) {
        for (let j = 0; j < 3; j = j + 1) {
          vector_math.Obb3._absR.setEntry(i, j, vector_math.Obb3._r.entry(i, j)[$abs]() + dart.notNull(epsilon));
        }
      }
      let ra = null;
      let rb = null;
      for (let i = 0; i < 3; i = i + 1) {
        ...
        rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(i, 0)) + dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(i, 1)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(i, 2));
        if (vector_math.Obb3._t._get(i)[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
          return false;
        }
      }
      for (let i = 0; i < 3; i = i + 1) {
        ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(0, i)) + dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(1, i)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(2, i));
        rb = other[_halfExtents]._get(i);
        if ((dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(0, i)) + dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(1, i)) + dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(2, i)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
          return false;
        }
      }
      ra = dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(2, 0)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(1, 0));
      rb = dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(0, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(0, 1));
      if ((dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(1, 0)) - dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(2, 0)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(2, 1)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(1, 1));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(0, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(0, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(1, 1)) - dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(2, 1)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(2, 2)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(1, 2));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(0, 1)) + dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(0, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(1, 2)) - dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(2, 2)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(2, 0)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(0, 0));
      rb = dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(1, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(1, 1));
      if ((dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(2, 0)) - dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(0, 0)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(2, 1)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(0, 1));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(1, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(1, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(2, 1)) - dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(0, 1)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(2, 2)) + dart.notNull(this[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(0, 2));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(1, 1)) + dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(1, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(2, 2)) - dart.notNull(vector_math.Obb3._t._get(2)) * dart.notNull(vector_math.Obb3._r.entry(0, 2)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(1, 0)) + dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(0, 0));
      rb = dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(2, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(2, 1));
      if ((dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(0, 0)) - dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(1, 0)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(1, 1)) + dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(0, 1));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(2, 2)) + dart.notNull(other[_halfExtents]._get(2)) * dart.notNull(vector_math.Obb3._absR.entry(2, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(0, 1)) - dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(1, 1)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      ra = dart.notNull(this[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(1, 2)) + dart.notNull(this[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(0, 2));
      rb = dart.notNull(other[_halfExtents]._get(0)) * dart.notNull(vector_math.Obb3._absR.entry(2, 1)) + dart.notNull(other[_halfExtents]._get(1)) * dart.notNull(vector_math.Obb3._absR.entry(2, 0));
      if ((dart.notNull(vector_math.Obb3._t._get(1)) * dart.notNull(vector_math.Obb3._r.entry(0, 2)) - dart.notNull(vector_math.Obb3._t._get(0)) * dart.notNull(vector_math.Obb3._r.entry(1, 2)))[$abs]() > dart.notNull(ra) + dart.notNull(rb)) {
        return false;
      }
      return true;
    }
    intersectsWithTriangle(other, opts) {
      ...
      t0$0;
      vector_math.Obb3._aabb3.setCenterAndHalfExtents(vector_math.Obb3._zeroVector, this[_halfExtents]);
    ...
    intersectsWithQuad(other, opts) {
      ...
      return dart.test(this.intersectsWithTriangle(vector_math.Obb3._quadTriangle0, {result: result})) || dart.test(this.intersectsWithTriangle(vector_math.Obb3._quadTriangle1, {result: result}));
    }
  };
  (vector_math.Obb3.new = function() {
    this[_center] = new vector_math.Vector3.zero();
    this[_halfExtents] = new vector_math.Vector3.zero();
    this[_axis0] = vector_math.Vector3.new(1.0, 0.0, 0.0);
    this[_axis1] = vector_math.Vector3.new(0.0, 1.0, 0.0);
    this[_axis2] = vector_math.Vector3.new(0.0, 0.0, 1.0);
    ;
  }).prototype = vector_math.Obb3.prototype;
  (vector_math.Obb3.copy = function(other) {
    this[_center] = vector_math.Vector3.copy(other[_center]);
    this[_halfExtents] = vector_math.Vector3.copy(other[_halfExtents]);
    this[_axis0] = vector_math.Vector3.copy(other[_axis0]);
    this[_axis1] = vector_math.Vector3.copy(other[_axis1]);
    this[_axis2] = vector_math.Vector3.copy(other[_axis2]);
    ;
  }).prototype = vector_math.Obb3.prototype;
  (vector_math.Obb3.centerExtentsAxes = function(center, halfExtents, axis0, axis1, axis2) {
    this[_center] = vector_math.Vector3.copy(center);
    this[_halfExtents] = vector_math.Vector3.copy(halfExtents);
    this[_axis0] = vector_math.Vector3.copy(axis0);
    this[_axis1] = vector_math.Vector3.copy(axis1);
    this[_axis2] = vector_math.Vector3.copy(axis2);
    ;
  }).prototype = vector_math.Obb3.prototype;
  ...
  dart.setMethodSignature(vector_math.Obb3, () => ({
    ...
    intersectsWithTriangle: dart.fnType(core.bool, [vector_math.Triangle], {result: vector_math.IntersectionResult}),
    intersectsWithVector3: dart.fnType(core.bool, [vector_math.Vector3]),
    intersectsWithQuad: dart.fnType(core.bool, [vector_math.Quad], {result: vector_math.IntersectionResult})
  }));
  ...
  dart.setLibraryUri(vector_math.Obb3, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Obb3, () => ({
    __proto__: dart.getFields(vector_math.Obb3.__proto__),
    [_center]: dart.finalFieldType(vector_math.Vector3),
    [_halfExtents]: dart.finalFieldType(vector_math.Vector3),
    [_axis0]: dart.finalFieldType(vector_math.Vector3),
    [_axis1]: dart.finalFieldType(vector_math.Vector3),
    [_axis2]: dart.finalFieldType(vector_math.Vector3)
  }));
  ...
  (vector_math.Plane.new = function() {
    this[_normal] = new vector_math.Vector3.zero();
    this[_constant] = 0.0;
    ;
  }).prototype = vector_math.Plane.prototype;
  (vector_math.Plane.copy = function(other) {
    this[_normal] = vector_math.Vector3.copy(other[_normal]);
    this[_constant] = other[_constant];
    ;
  }).prototype = vector_math.Plane.prototype;
  (vector_math.Plane.components = function(x, y, z, w) {
    this[_normal] = vector_math.Vector3.new(x, y, z);
    this[_constant] = w;
    ;
  }).prototype = vector_math.Plane.prototype;
  (vector_math.Plane.normalconstant = function(normal_, constant_) {
    this[_normal] = vector_math.Vector3.copy(normal_);
  ...
  dart.setSetterSignature(vector_math.Plane, () => ({
    __proto__: dart.getSetters(vector_math.Plane.__proto__),
    constant: core.double
  }));
  dart.setLibraryUri(vector_math.Plane, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Plane, () => ({
    __proto__: dart.getFields(vector_math.Plane.__proto__),
    [_normal]: dart.finalFieldType(vector_math.Vector3),
  ...
  (vector_math.Quad.new = function() {
    this[_point0] = new vector_math.Vector3.zero();
    this[_point1] = new vector_math.Vector3.zero();
    this[_point2] = new vector_math.Vector3.zero();
    this[_point3] = new vector_math.Vector3.zero();
    ;
  }).prototype = vector_math.Quad.prototype;
  (vector_math.Quad.copy = function(other) {
    this[_point0] = vector_math.Vector3.copy(other[_point0]);
    this[_point1] = vector_math.Vector3.copy(other[_point1]);
    this[_point2] = vector_math.Vector3.copy(other[_point2]);
    this[_point3] = vector_math.Vector3.copy(other[_point2]);
    ;
  }).prototype = vector_math.Quad.prototype;
  (vector_math.Quad.points = function(point0, point1, point2, point3) {
    this[_point0] = vector_math.Vector3.copy(point0);
    this[_point1] = vector_math.Vector3.copy(point1);
    this[_point2] = vector_math.Vector3.copy(point2);
    this[_point3] = vector_math.Vector3.copy(point3);
    ;
  }).prototype = vector_math.Quad.prototype;
  ...
  dart.setLibraryUri(vector_math.Quad, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Quad, () => ({
    __proto__: dart.getFields(vector_math.Quad.__proto__),
    [_point0]: dart.finalFieldType(vector_math.Vector3),
    [_point1]: dart.finalFieldType(vector_math.Vector3),
    [_point2]: dart.finalFieldType(vector_math.Vector3),
    [_point3]: dart.finalFieldType(vector_math.Vector3)
  }));
  vector_math.Quaternion = class Quaternion extends core.Object {
    ...
    get axis() {
      ...
      return vector_math.Vector3.new(dart.notNull(this[_qStorage$][$_get](0)) * scale, dart.notNull(this[_qStorage$][$_get](1)) * scale, dart.notNull(this[_qStorage$][$_get](2)) * scale);
    }
    get length2() {
    ...
    copyRotationInto(rotationMatrix) {
      let d = this.length2;
      if (!(d !== 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/vector_math/src/vector_math/quaternion.dart", 420, 12, "d != 0.0");
  ...
  (vector_math.Quaternion.__ = function() {
    this[_qStorage$] = _native_typed_data.NativeFloat32List.new(4);
    ;
  ...
  (vector_math.Quaternion.fromBuffer = function(buffer, offset) {
    this[_qStorage$] = typed_data.Float32List.view(buffer, offset, 4);
    ;
  }).prototype = vector_math.Quaternion.prototype;
  ...
  dart.setLibraryUri(vector_math.Quaternion, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Quaternion, () => ({
    __proto__: dart.getFields(vector_math.Quaternion.__proto__),
    [_qStorage$]: dart.finalFieldType(typed_data.Float32List)
  }));
  dart.defineExtensionMethods(vector_math.Quaternion, ['toString']);
  const _origin = dart.privateName(vector_math, "_origin");
  const _direction = dart.privateName(vector_math, "_direction");
  vector_math.Ray = class Ray extends core.Object {
    ...
    intersectsWithTriangle(other) {
      ...
      t0$.sub(point0);
      t0$;
      this[_direction].crossInto(vector_math.Ray._e2, vector_math.Ray._q);
      ...
      t0$0.sub(point0);
      t0$0;
      let u = f * dart.notNull(vector_math.Ray._s.dot(vector_math.Ray._q));
      if (u < 0.0) {
        return null;
      }
      vector_math.Ray._s.crossInto(vector_math.Ray._e1, vector_math.Ray._r);
      let v = f * dart.notNull(this[_direction].dot(vector_math.Ray._r));
      if (v < -0.00001 || u + v > 1.0 + 0.00001) {
        return null;
      }
      let t = f * dart.notNull(vector_math.Ray._e2.dot(vector_math.Ray._r));
      return t;
    }
  ...
  (vector_math.Ray.new = function() {
    this[_origin] = new vector_math.Vector3.zero();
    this[_direction] = new vector_math.Vector3.zero();
    ;
  }).prototype = vector_math.Ray.prototype;
  (vector_math.Ray.copy = function(other) {
    this[_origin] = vector_math.Vector3.copy(other[_origin]);
    this[_direction] = vector_math.Vector3.copy(other[_direction]);
    ;
  }).prototype = vector_math.Ray.prototype;
  (vector_math.Ray.originDirection = function(origin, direction) {
    this[_origin] = vector_math.Vector3.copy(origin);
    this[_direction] = vector_math.Vector3.copy(direction);
    ;
  }).prototype = vector_math.Ray.prototype;
  ...
  dart.setMethodSignature(vector_math.Ray, () => ({
    ...
    intersectsWithSphere: dart.fnType(core.double, [vector_math.Sphere]),
    intersectsWithTriangle: dart.fnType(core.double, [vector_math.Triangle]),
    intersectsWithQuad: dart.fnType(core.double, [vector_math.Quad]),
    intersectsWithAabb3: dart.fnType(core.double, [vector_math.Aabb3])
  }));
  ...
  dart.setLibraryUri(vector_math.Ray, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Ray, () => ({
    __proto__: dart.getFields(vector_math.Ray.__proto__),
    [_origin]: dart.finalFieldType(vector_math.Vector3),
    [_direction]: dart.finalFieldType(vector_math.Vector3)
  }));
  ...
  dart.setSetterSignature(vector_math.Sphere, () => ({
    __proto__: dart.getSetters(vector_math.Sphere.__proto__),
    radius: core.double
  }));
  dart.setLibraryUri(vector_math.Sphere, "package:vector_math/vector_math.dart");
  ...
  const _perm = dart.privateName(vector_math, "_perm");
  const _permMod12 = dart.privateName(vector_math, "_permMod12");
  const _dot2 = dart.privateName(vector_math, "_dot2");
  const _dot3 = dart.privateName(vector_math, "_dot3");
  const _dot4 = dart.privateName(vector_math, "_dot4");
  vector_math.SimplexNoise = class SimplexNoise extends core.Object {
    ...
    noise2D(xin, yin) {
      ...
      let n1 = null;
      let n2 = null;
      let s = (dart.notNull(xin) + dart.notNull(yin)) * dart.notNull(vector_math.SimplexNoise._F2);
      let i = (dart.notNull(xin) + s)[$floor]();
      let j = (dart.notNull(yin) + s)[$floor]();
      let t = (i + j) * dart.notNull(vector_math.SimplexNoise._G2);
      let X0 = i - t;
      let Y0 = j - t;
      ...
      let x1 = x0 - dart.notNull(i1) + dart.notNull(vector_math.SimplexNoise._G2);
      let y1 = y0 - dart.notNull(j1) + dart.notNull(vector_math.SimplexNoise._G2);
      let x2 = x0 - 1.0 + 2.0 * dart.notNull(vector_math.SimplexNoise._G2);
      let y2 = y0 - 1.0 + 2.0 * dart.notNull(vector_math.SimplexNoise._G2);
      let ii = i & 255;
      let jj = j & 255;
      ...
      if (t0 < 0)
        ...
        t0 = t0 * t0;
        n0 = t0 * t0 * dart.notNull(this[_dot2](vector_math.SimplexNoise._grad3[$_get](gi0), x0, y0));
      }
      ...
      if (t1 < 0)
        ...
        t1 = t1 * t1;
        n1 = t1 * t1 * dart.notNull(this[_dot2](vector_math.SimplexNoise._grad3[$_get](gi1), x1, y1));
      }
      ...
      if (t2 < 0)
        ...
        t2 = t2 * t2;
        n2 = t2 * t2 * dart.notNull(this[_dot2](vector_math.SimplexNoise._grad3[$_get](gi2), x2, y2));
      }
    ...
    noise3D(xin, yin, zin) {
      ...
      if (t0 < 0)
        ...
        t0 = t0 * t0;
        n0 = t0 * t0 * dart.notNull(this[_dot3](vector_math.SimplexNoise._grad3[$_get](gi0), x0, y0, z0));
      }
      ...
      if (t1 < 0)
        ...
        t1 = t1 * t1;
        n1 = t1 * t1 * dart.notNull(this[_dot3](vector_math.SimplexNoise._grad3[$_get](gi1), x1, y1, z1));
      }
      ...
      if (t2 < 0)
        ...
        t2 = t2 * t2;
        n2 = t2 * t2 * dart.notNull(this[_dot3](vector_math.SimplexNoise._grad3[$_get](gi2), x2, y2, z2));
      }
      ...
      if (t3 < 0)
        ...
        t3 = t3 * t3;
        n3 = t3 * t3 * dart.notNull(this[_dot3](vector_math.SimplexNoise._grad3[$_get](gi3), x3, y3, z3));
      }
    ...
    noise4D(x, y, z, w) {
      ...
      let n3 = null;
      let n4 = null;
      let s = (dart.notNull(x) + dart.notNull(y) + dart.notNull(z) + dart.notNull(w)) * dart.notNull(vector_math.SimplexNoise._F4);
      let i = (dart.notNull(x) + s)[$floor]();
      let j = (dart.notNull(y) + s)[$floor]();
      let k = (dart.notNull(z) + s)[$floor]();
      let l = (dart.notNull(w) + s)[$floor]();
      let t = (i + j + k + l) * dart.notNull(vector_math.SimplexNoise._G4);
      let X0 = i - t;
      let Y0 = j - t;
      let Z0 = k - t;
      let W0 = l - t;
      ...
      k3 = rankz >= 1 ? 1 : 0;
      l3 = rankw >= 1 ? 1 : 0;
      let x1 = x0 - dart.notNull(i1) + dart.notNull(vector_math.SimplexNoise._G4);
      let y1 = y0 - dart.notNull(j1) + dart.notNull(vector_math.SimplexNoise._G4);
      let z1 = z0 - dart.notNull(k1) + dart.notNull(vector_math.SimplexNoise._G4);
      let w1 = w0 - dart.notNull(l1) + dart.notNull(vector_math.SimplexNoise._G4);
      let x2 = x0 - dart.notNull(i2) + 2.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let y2 = y0 - dart.notNull(j2) + 2.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let z2 = z0 - dart.notNull(k2) + 2.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let w2 = w0 - dart.notNull(l2) + 2.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let x3 = x0 - dart.notNull(i3) + 3.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let y3 = y0 - dart.notNull(j3) + 3.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let z3 = z0 - dart.notNull(k3) + 3.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let w3 = w0 - dart.notNull(l3) + 3.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let x4 = x0 - 1.0 + 4.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let y4 = y0 - 1.0 + 4.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let z4 = z0 - 1.0 + 4.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let w4 = w0 - 1.0 + 4.0 * dart.notNull(vector_math.SimplexNoise._G4);
      let ii = i & 255;
      let jj = j & 255;
      let kk = k & 255;
      let ll = l & 255;
      ...
      if (t0 < 0)
        ...
        t0 = t0 * t0;
        n0 = t0 * t0 * dart.notNull(this[_dot4](vector_math.SimplexNoise._grad4[$_get](gi0), x0, y0, z0, w0));
      }
      ...
      if (t1 < 0)
        ...
        t1 = t1 * t1;
        n1 = t1 * t1 * dart.notNull(this[_dot4](vector_math.SimplexNoise._grad4[$_get](gi1), x1, y1, z1, w1));
      }
      ...
      if (t2 < 0)
        ...
        t2 = t2 * t2;
        n2 = t2 * t2 * dart.notNull(this[_dot4](vector_math.SimplexNoise._grad4[$_get](gi2), x2, y2, z2, w2));
      }
      ...
      if (t3 < 0)
        ...
        t3 = t3 * t3;
        n3 = t3 * t3 * dart.notNull(this[_dot4](vector_math.SimplexNoise._grad4[$_get](gi3), x3, y3, z3, w3));
      }
      ...
      if (t4 < 0)
        ...
        t4 = t4 * t4;
        n4 = t4 * t4 * dart.notNull(this[_dot4](vector_math.SimplexNoise._grad4[$_get](gi4), x4, y4, z4, w4));
      }
      return 27.0 * (dart.notNull(n0) + dart.notNull(n1) + dart.notNull(n2) + dart.notNull(n3) + dart.notNull(n4));
    }
  };
  (vector_math.SimplexNoise.new = function(r) {
    if (r === void 0) r = null;
    this[_perm] = null;
  ...
  dart.setLibraryUri(vector_math.SimplexNoise, "package:vector_math/vector_math.dart");
  ...
  dart.setLibraryUri(vector_math.Triangle, "package:vector_math/vector_math.dart");
  ...
  dart.setLibraryUri(vector_math.Vector, "package:vector_math/vector_math.dart");
  vector_math.Vector2 = class Vector2 extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      return vector_math.Vector2.is(other) && this[_v2storage$][$_get](0) == other[_v2storage$][$_get](0) && this[_v2storage$][$_get](1) == other[_v2storage$][$_get](1);
    }
    get hashCode() {
    ...
    get xx() {
      return vector_math.Vector2.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get xy() {
      return vector_math.Vector2.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get yx() {
      return vector_math.Vector2.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get yy() {
      return vector_math.Vector2.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get xxx() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get xxy() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get xyx() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get xyy() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get yxx() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get yxy() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get yyx() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get yyy() {
      return vector_math.Vector3.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get xxxx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get xxxy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get xxyx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get xxyy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get xyxx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get xyxy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get xyyx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get xyyy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get yxxx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get yxxy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get yxyx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get yxyy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get yyxx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](0));
    }
    get yyxy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0), this[_v2storage$][$_get](1));
    }
    get yyyx() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](0));
    }
    get yyyy() {
      return vector_math.Vector4.new(this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1), this[_v2storage$][$_get](1));
    }
    get r() {
      return this.x;
    }
  ...
  (vector_math.Vector2.zero = function() {
    this[_v2storage$] = _native_typed_data.NativeFloat32List.new(2);
    ;
  ...
  (vector_math.Vector2.fromBuffer = function(buffer, offset) {
    this[_v2storage$] = typed_data.Float32List.view(buffer, offset, 2);
    ;
  }).prototype = vector_math.Vector2.prototype;
  ...
  dart.setLibraryUri(vector_math.Vector2, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Vector2, () => ({
    __proto__: dart.getFields(vector_math.Vector2.__proto__),
    [_v2storage$]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  vector_math.Vector3 = class Vector3 extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      return vector_math.Vector3.is(other) && this[_v3storage$][$_get](0) == other[_v3storage$][$_get](0) && this[_v3storage$][$_get](1) == other[_v3storage$][$_get](1) && this[_v3storage$][$_get](2) == other[_v3storage$][$_get](2);
    }
    get hashCode() {
    ...
    cross(other) {
      ...
      let oy = otherStorage[$_get](1);
      let oz = otherStorage[$_get](2);
      return vector_math.Vector3.new(dart.notNull(_y) * dart.notNull(oz) - dart.notNull(_z) * dart.notNull(oy), dart.notNull(_z) * dart.notNull(ox) - dart.notNull(_x) * dart.notNull(oz), dart.notNull(_x) * dart.notNull(oy) - dart.notNull(_y) * dart.notNull(ox));
    }
    crossInto(other, out) {
    ...
    get xx() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get xy() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get xz() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get yx() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get yy() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get yz() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get zx() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get zy() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get zz() {
      return vector_math.Vector2.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get xxx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get xxy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get xxz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get xyx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get xyy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get xyz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get xzx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get xzy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get xzz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get yxx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get yxy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get yxz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get yyx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get yyy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get yyz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get yzx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get yzy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get yzz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get zxx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get zxy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get zxz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get zyx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get zyy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get zyz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get zzx() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get zzy() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get zzz() {
      return vector_math.Vector3.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get xxxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get xxxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get xxxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get xxyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get xxyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get xxyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get xxzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get xxzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get xxzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get xyxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get xyxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get xyxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get xyyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get xyyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get xyyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get xyzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get xyzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get xyzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get xzxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get xzxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get xzxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get xzyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get xzyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get xzyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get xzzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get xzzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get xzzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get yxxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get yxxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get yxxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get yxyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get yxyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get yxyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get yxzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get yxzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get yxzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get yyxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get yyxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get yyxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get yyyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get yyyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get yyyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get yyzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get yyzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get yyzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get yzxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get yzxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get yzxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get yzyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get yzyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get yzyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get yzzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get yzzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get yzzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get zxxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get zxxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get zxxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get zxyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get zxyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get zxyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get zxzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get zxzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get zxzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get zyxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get zyxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get zyxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get zyyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get zyyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get zyyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get zyzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get zyzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get zyzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get zzxx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](0));
    }
    get zzxy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](1));
    }
    get zzxz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0), this[_v3storage$][$_get](2));
    }
    get zzyx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](0));
    }
    get zzyy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](1));
    }
    get zzyz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1), this[_v3storage$][$_get](2));
    }
    get zzzx() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](0));
    }
    get zzzy() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](1));
    }
    get zzzz() {
      return vector_math.Vector4.new(this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2), this[_v3storage$][$_get](2));
    }
    get r() {
      return this.x;
    }
  ...
  (vector_math.Vector3.zero = function() {
    this[_v3storage$] = _native_typed_data.NativeFloat32List.new(3);
    ;
  ...
  (vector_math.Vector3.fromBuffer = function(buffer, offset) {
    this[_v3storage$] = typed_data.Float32List.view(buffer, offset, 3);
    ;
  }).prototype = vector_math.Vector3.prototype;
  ...
  dart.setLibraryUri(vector_math.Vector3, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Vector3, () => ({
    __proto__: dart.getFields(vector_math.Vector3.__proto__),
    [_v3storage$]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  vector_math.Vector4 = class Vector4 extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      return vector_math.Vector4.is(other) && this[_v4storage$][$_get](0) == other[_v4storage$][$_get](0) && this[_v4storage$][$_get](1) == other[_v4storage$][$_get](1) && this[_v4storage$][$_get](2) == other[_v4storage$][$_get](2) && this[_v4storage$][$_get](3) == other[_v4storage$][$_get](3);
    }
    get hashCode() {
    ...
    get xx() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xy() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xz() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xw() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get yx() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get yy() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get yz() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get yw() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zx() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zy() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zz() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zw() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wx() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wy() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wz() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get ww() {
      return vector_math.Vector2.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get xxx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xxy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xxz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xxw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get xyx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get xyy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get xyz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get xyw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get xzx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get xzy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get xzz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get xzw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get xwx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get xwy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get xwz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get xww() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get yxx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get yxy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get yxz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get yxw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get yyx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get yyy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get yyz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get yyw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get yzx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get yzy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get yzz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get yzw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get ywx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get ywy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get ywz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get yww() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get zxx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get zxy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get zxz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get zxw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get zyx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get zyy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get zyz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get zyw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zzx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zzy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zzz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zzw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get zwx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get zwy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get zwz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get zww() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get wxx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get wxy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get wxz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get wxw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get wyx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get wyy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get wyz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get wyw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get wzx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get wzy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get wzz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get wzw() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wwx() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wwy() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wwz() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get www() {
      return vector_math.Vector3.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get xxxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xxxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xxxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xxxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get xxyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get xxyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get xxyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get xxyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get xxzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get xxzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get xxzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get xxzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get xxwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get xxwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get xxwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get xxww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get xyxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xyxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xyxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xyxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get xyyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get xyyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get xyyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get xyyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get xyzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get xyzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get xyzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get xyzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get xywx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get xywy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get xywz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get xyww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get xzxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xzxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xzxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xzxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get xzyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get xzyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get xzyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get xzyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get xzzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get xzzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get xzzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get xzzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get xzwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get xzwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get xzwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get xzww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get xwxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get xwxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get xwxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get xwxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get xwyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get xwyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get xwyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get xwyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get xwzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get xwzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get xwzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get xwzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get xwwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get xwwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get xwwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get xwww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get yxxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get yxxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get yxxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get yxxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get yxyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get yxyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get yxyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get yxyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get yxzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get yxzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get yxzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get yxzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get yxwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get yxwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get yxwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get yxww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get yyxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get yyxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get yyxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get yyxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get yyyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get yyyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get yyyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get yyyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get yyzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get yyzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get yyzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get yyzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get yywx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get yywy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get yywz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get yyww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get yzxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get yzxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get yzxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get yzxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get yzyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get yzyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get yzyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get yzyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get yzzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get yzzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get yzzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get yzzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get yzwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get yzwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get yzwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get yzww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get ywxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get ywxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get ywxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get ywxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get ywyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get ywyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get ywyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get ywyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get ywzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get ywzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get ywzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get ywzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get ywwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get ywwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get ywwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get ywww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get zxxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get zxxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get zxxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get zxxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get zxyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get zxyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get zxyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get zxyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zxzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zxzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zxzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zxzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get zxwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get zxwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get zxwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get zxww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get zyxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get zyxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get zyxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get zyxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get zyyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get zyyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get zyyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get zyyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zyzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zyzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zyzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zyzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get zywx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get zywy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get zywz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get zyww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get zzxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get zzxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get zzxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get zzxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get zzyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get zzyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get zzyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get zzyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zzzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zzzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zzzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zzzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get zzwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get zzwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get zzwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get zzww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get zwxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get zwxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get zwxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get zwxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get zwyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get zwyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get zwyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get zwyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get zwzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get zwzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get zwzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get zwzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get zwwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get zwwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get zwwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get zwww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get wxxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get wxxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get wxxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get wxxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get wxyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get wxyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get wxyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get wxyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get wxzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get wxzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get wxzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get wxzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wxwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wxwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wxwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get wxww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get wyxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get wyxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get wyxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get wyxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get wyyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get wyyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get wyyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get wyyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get wyzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get wyzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get wyzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get wyzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wywx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wywy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wywz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get wyww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get wzxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get wzxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get wzxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get wzxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get wzyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get wzyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get wzyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get wzyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get wzzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get wzzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get wzzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get wzzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wzwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wzwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wzwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get wzww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get wwxx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](0));
    }
    get wwxy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](1));
    }
    get wwxz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](2));
    }
    get wwxw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0), this[_v4storage$][$_get](3));
    }
    get wwyx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](0));
    }
    get wwyy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](1));
    }
    get wwyz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](2));
    }
    get wwyw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1), this[_v4storage$][$_get](3));
    }
    get wwzx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](0));
    }
    get wwzy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](1));
    }
    get wwzz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](2));
    }
    get wwzw() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2), this[_v4storage$][$_get](3));
    }
    get wwwx() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](0));
    }
    get wwwy() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](1));
    }
    get wwwz() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](2));
    }
    get wwww() {
      return vector_math.Vector4.new(this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3), this[_v4storage$][$_get](3));
    }
    get r() {
      return this.x;
    }
  ...
  (vector_math.Vector4.zero = function() {
    this[_v4storage$] = _native_typed_data.NativeFloat32List.new(4);
    ;
  ...
  (vector_math.Vector4.fromBuffer = function(buffer, offset) {
    this[_v4storage$] = typed_data.Float32List.view(buffer, offset, 4);
    ;
  }).prototype = vector_math.Vector4.prototype;
  ...
  dart.setLibraryUri(vector_math.Vector4, "package:vector_math/vector_math.dart");
  dart.setFieldSignature(vector_math.Vector4, () => ({
    __proto__: dart.getFields(vector_math.Vector4.__proto__),
    [_v4storage$]: dart.finalFieldType(typed_data.Float32List)
  }));
  ...
  vector_math.makePlaneProjection = function makePlaneProjection(planeNormal, planePoint) {
    let v = vector_math.Vector4.new(planeNormal.storage[$_get](0), planeNormal.storage[$_get](1), planeNormal.storage[$_get](2), 0.0);
    let outer = vector_math.Matrix4.outer(v, v);
    let r = new vector_math.Matrix4.zero();
    r = r['-'](outer);
    let scaledNormal = planeNormal.scaled(vector_math.dot3(planePoint, planeNormal));
    let T = vector_math.Vector4.new(scaledNormal.storage[$_get](0), scaledNormal.storage[$_get](1), scaledNormal.storage[$_get](2), 1.0);
    r.setColumn(3, T);
    return r;
  };
  vector_math.makePlaneReflection = function makePlaneReflection(planeNormal, planePoint) {
    let t0;
    let v = vector_math.Vector4.new(planeNormal.storage[$_get](0), planeNormal.storage[$_get](1), planeNormal.storage[$_get](2), 0.0);
    let outer = (t0 = vector_math.Matrix4.outer(v, v), t0.scale(2.0), t0);
    let r = new vector_math.Matrix4.zero();
    r = r['-'](outer);
  ...
  vector_math.unproject = function unproject(cameraMatrix, viewportX, viewportWidth, viewportY, viewportHeight, pickX, pickY, pickZ, pickWorld) {
    ...
    let v = vector_math.Vector4.new(pickX[$toDouble](), pickY[$toDouble](), pickZ[$toDouble](), 1.0);
  ...
  vector_math.pickRay = function pickRay(cameraMatrix, viewportX, viewportWidth, viewportY, viewportHeight, pickX, pickY, rayNear, rayFar) {
    let r = null;
    r = vector_math.unproject(cameraMatrix, viewportX, viewportWidth, viewportY, viewportHeight, pickX, dart.notNull(viewportHeight) - dart.notNull(pickY), 0.0, rayNear);
    if (!dart.test(r)) {
      return false;
    }
    r = vector_math.unproject(cameraMatrix, viewportX, viewportWidth, viewportY, viewportHeight, pickX, dart.notNull(viewportHeight) - dart.notNull(pickY), 1.0, rayFar);
    return r;
  };
  ...
  dart.trackLibraries("packages/vector_math/vector_math", {
...
//# sourceMappingURL=vector_math.ddc.js.map
